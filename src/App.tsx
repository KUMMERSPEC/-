...
export default function App() {
  ...
  const handleSpeak = (text: string, kana?: string) => {
    if ('speechSynthesis' in window) {
      ...
      // Use kana pronunciation if available to handle multi-reading kanji (like 後: うしろ vs あと)
      ...
      <main className="max-w-6xl mx-auto py-4">
                    ...
                    {activePreviewDeck.words.length === 0 ? (
                      ...
                      activePreviewDeck.words.map((word, index) => (
                        ...
                        >
                          ...
                          <button
                            onClick={() => handleSpeak(word.kanji, word.kana)}
        ...
        {activeTab === 'test' && (
          <TestPanel
            ...
            defaultDeckId={activePreviewDeck?.id}
            autoStart={autoStartTest}
            onStartedTesting={() => setAutoStartTest(false)}
          />
        )}
